...
Add Stripe payment gateway to your WooCommerce store to accept payments via credit, debit cards, Alipay, Apple Pay, and Google Pay.
...
With this plugin, your customer can use their credit/debit cards during the checkout process and Stripe.com handles the rest. This means a smoother experience for your users as they never have to leave your website for making payments.

What else? A unique and intuitive stripe overview page will provide you a consolidated overview of Stripe Payments, where you can do one click capture and refund of payments.

Integrating the Stripe Payment Gateway in your WooCommerce store would be the best way to enable a smooth payment flow for your customers and business.
...
= MAJOR FEATURES OF THE WOOCOMMERCE STRIPE PLUGIN =
...
= Premium version Features =
 ...
 &#9989; <strong>Apple Pay Supported</strong>: Integrate Apple Pay with Product, Cart and Checkout Page.
 &#9989; Google Pay Supported.
 &#9989; Supports WooCommerce Subscriptions.
 &#9989; Advanced customization options.
 &#9989; Enable stripe credit card inline form.
 &#9989; Set up Stripe checkout landing page locale.
...
= Does the WooCommerce Stripe Payment Gateway Plugin support Alipay through Stripe checkout? = 
